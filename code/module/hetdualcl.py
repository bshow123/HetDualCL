...
from .gcc_model import GCCModel
from .gnn_encoder import GNN_encoder


class HetDualCL(nn.Module):
    ...
    def __init__(self, hidden_dim, feats_dim_list, feat_drop, P, tau, lam, t_hops, t_n_class, t_input_dim, t_pe_dim,
        ...
        # hops view encoder
        # print("t.hop:", self.t_hops)
        self.transformer_list = nn.ModuleList([GCCModel(hops=t_hops,
                                                                n_class=t_n_class,
...
class Attention(nn.Module):
    def __init__(self, hidden_dim, attn_drop):
        ...
        self.tanh = nn.Tanh()
        self.sigma = nn.LeakyReLU(negative_slope=0.1)
    ...
    def forward(self, embeds):
        ...
        for embed in embeds:
            ...
            score = self.sigma(attn_curr.matmul(sp.t()))
            beta.append(score)
