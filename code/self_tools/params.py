...
def acm_params():
    ...
    parser.add_argument('--t_hops', type=int, default=2, help='Hop of neighbors to be calculated')
...
def dblp_params():
    ...
    # transformer related parameters
    parser.add_argument('--t_hops', type=int, default=1,help='Hop of neighbors to be calculated')
...
def freebase_params():
    ...
    # transformer related parameters
    parser.add_argument('--t_hops', type=int, default=8, help='Hop of neighbors to be calculated')
    parser.add_argument('--t_pe_dim', type=int, default=20,
                        help='position embedding size')
    parser.add_argument('--t_n_layers', type=int, default=3,
                        help='Number of Transformer layers')
    ...
    parser.add_argument('--t_dropout', type=float, default=0.1,
                        help='Dropout')
    parser.add_argument('--t_attention_dropout', type=float, default=0.5,
                        help='Dropout in the attention layer')
    # --------------------------------------------------------------------------------
...
def academic_params():
    ...
    parser.add_argument('--gnn_branch_layer_num', type=int, default=4)#4
    parser.add_argument('--batch_size', type=int, default=256)
    # The parameters of evaluation
    parser.add_argument('--eva_lr', type=float, default=0.01)
    parser.add_argument('--eva_wd', type=float, default=0)
    ...
    parser.add_argument('--lam', type=float, default=0.1)
    parser.add_argument('--feat_drop', type=float, default=0.7)
    # transformer related parameter
    parser.add_argument('--t_hops', type=int, default=4,help='Hop of neighbors to be calculated')
    parser.add_argument('--t_pe_dim', type=int, default=20,
                        help='position embedding size')
    parser.add_argument('--t_n_layers', type=int, default=3,
                        help='Number of Transformer layers')
